...
mark each commute type with it's own color. Here, commuting by car is maroon, and commuting by public transit is orange. Walking and biking are also available as data points, but no 
neighborhood saw primarily and walking or biking commuters
